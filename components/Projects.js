  ...
  return (
    <div className='mt-12 padding-x padding-y max-width' id='projects'>
      ...
      <div className="grid gap-x-6 lg:grid-cols-3 lg:gap-x-12">
        {projects.map((p, i) => {
            return (
              <div key={i} className="mb-6 mt-16 block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] light:bg-neutral-700 lg:mb-0" data-te-ripple-init data-te-ripple-color="light">
                <div className="relative overflow-hidden bg-cover bg-no-repeat">
                  ...
                  <svg className="absolute left-0 bottom-0 text-white light:text-neutral-700" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
