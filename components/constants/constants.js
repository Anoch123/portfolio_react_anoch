export const projects = [
  {
    ...
    description:
      "I've developed my portfolio which you are looking with the help of Next js which is the best react js framework in the market right now. I've learned so many stuffs including the state management and many more. Everything which is done in this project is done using the best practises that i've learned so far by developing multiple projects.",
  ...
  {
    title: "Lencar.lk - Electric Mobility Platform",
    description:
  ...
  {
    title: "Lagoon Lanka - Tourism & Booking Platform",
    description:
  ...
  {
    title: "AGAPE GEAR - Clothing Brand E-Commerce",
    description:
  ...
  },
  {
    title: "SLM HR Portal",
    description:
      "Designed and developed a comprehensive Human Resource Management System to streamline employee management, attendance tracking, leave management, user roles, and administrative workflows. Built secure authentication, role-based access control, reporting features, and responsive dashboards to improve operational efficiency and workforce management.",
    image: "/images/slmhrportal.png",
    tags: [
      "Next.js",
      "TypeScript",
      "Supabase",
...
export const Aboutme = [
  {
    id: 1,
    description:
      "I am a passionate software engineer with two and half years of experience. With expertise in a wide range of technologies, including React, React Native, PHP, Node.js, HTML, Bootstrap, MySQL, jQuery, JavaScript, MongoDB and Tailwind CSS, I am dedicated to delivering exceptional web and mobile applications.",
  },
  {
    id: 2,
    description:
...
export const ContactDetails = [
  {
    key: "location",
    type: "Location",
    details: "Station Road Maggona Kaluthara Sri Lanka",
    image: "/location.svg",
  },
  {
    key: "email",
    type: "Mail",
    details: "anochdissanayake@gmail.com",
    image: "/email.svg",
  },
  {
    key: "facebook",
    type: "Facebook",
    details: "facebook.com/anoch",
    image: "/facebook.svg",
  },
  {
    key: "linkedin",
    type: "LinkedIn",
    details: "linkedin.com/in/anoch-dissanayake",
    image: "/linkedin.svg",
  },
  {
    key: "github",
    type: "GitHub",
    details: "github.com/anoch123",
    image: "/github.svg",
  },
  {
    key: "instagram",
    type: "Instagram",
    details: "instagram.com/theanochyeshurun",
    image: "/instagram.svg",
  },
];

export const SVG_ICONS = {
  location: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-map-pin"><path d="M12 12l-6-6-6-6"></path><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z"></path><circle cx="12" cy="9" r="3"></circle></svg>`,
  ...
  facebook: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-facebook"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>`,
  linkedin: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-linkedin"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2a2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect width="4" height="12" x="2" y="9"></rect><circle cx="4" cy="4" r="2"></circle></svg>`,
  github: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-github"><path d="M15 22s-4 0-6-2c0 0-1 0-1-2s1-2 1-2a6.3 6.3 0 0 1 4-2c0-1-1-2-1-2s0-1 2-1s2 1 2 2 1 2 1 2a6.3 6.3 0 0 1 4 2c0 0 1 0 1 2s-1 2-1 2c-2 2-6 2-6 2H9c0 0-4 0-6-2c0 0-1 0-1-2s1-2 1-2a6.3 6.3 0 0 1 4-2c0-1-1-2-1-2s0-1 2-1s2 1 2 2 1 2 1 2a6.3 6.3 0 0 1 4 2c0 0 1 0 1 2s-1 2-1 2c-2 2-6 2-6 2H15z"></path></svg>`,
...
export const workExperience = [
  {
    id: 1,
    company: "Lencar Pvt Ltd.",
    position: "Associate Software Engineer",
    duration: "2024 - Present",
    location: "Borella",
    type: "Current",
    description:
      "Developed backend services for electric bike home charging and dynamic customer packages using Go, MySQL, DynamoDB, and AWS Lambda, integrated with Flutter apps and Yii2 back office. Implemented AWS Cognito SSO for secure staff access and integrated real-time bank API for advance payment top-ups, improving efficiency and accuracy.",
    skills: [
      "Php",
      "Yii2",
      "Node.js",
    ...
    achievements: [
      "Developed scalable backend services for electric bike charging and dynamic customer packages with real-time mobile app integration.",
      "Implemented AWS Cognito SSO for secure, unified staff access across platforms.",
      "Integrated bank API for advance payment top-ups, reducing processing time by 90% and ensuring accurate transactions.",
      "Streamlined backend workflows and improved system reliability through Go, Yii2, MySQL, and DynamoDB solutions.",
    ],
  ...
  },
  {
    ...
    type: "Previous",
    description:
      "Developed React Native apps, custom Android browsers, and complex web systems using PHP/MySQL for real-time content management, e-commerce, and business automation. Gained advanced skills in PHP, Node.js, React.js, React Native, and jQuery to deliver high-performance, client-focused applications.",
    skills: [
      "JavaScript",
      "React Native",
      "Php",
    ...
    achievements: [
      "Developed synchronized React Native apps enabling real-time advertising control",
      "Built a personalized prayer time app with location-based notifications.",
      "Created a custom Android browser tailored for clients’ needs.",
      "Led development of complex web systems automating business operations.",
      "Delivered a full-featured, secure e-commerce website.",
      "Optimized database queries and improved application performance across projects.",
    ],
  ...
  },
  {
    ...
    duration: "2022(1 Year)",
    location: "Beruwala",
    type: "Previous",
    description:
      "Worked on front-end and back-end development, bug fixing, and database management. Collaborated with senior developers, gained hands-on experience with APIs and SQL, and progressively handled independent tasks to build practical software engineering skills.",
    skills: ["JavaScript", "Php", "MySQL", "React Native", "HTML", "CSS"],
    achievements: [
      "Worked on front-end/back-end development",
      "Bug fixing in existing applications.",
      "Improved app stability, optimized queries, and delivered a small feature independently.",
    ],
    color: "from-red-700 to-pink-600",
  },
  {
    id: 4,
    company: "Sandan Lanka Pvt Ltd.",
    position: "Social Media Marketing Salesman",
    duration: "2021(1 Year)",
    location: "Bambalapitiya",
    type: "Previous",
    description:
      "Start of journey by Managing social media marketing campaigns across Facebook, Instagram, and Tiktok, creating content, monitoring performance, and implementing strategies to boost engagement and brand visibility.",
    skills: [
      "Facebook Marketing",
      "Instagram Marketing",
      "Tiktok Marketing",
    ...
    achievements: [
      "Successfully enhanced the company’s online presence and audience reach",
      "Gained foundational understanding of e-commerce operations and strategies for effectively reaching target audiences.",
    ],
...
export const timelineEvents = [
  {
    year: "2023",
    title: "Lead Developer at Innovatech Solutions",
    description:
      "Led a team of 5 developers to launch a new e-commerce platform, increasing sales by 30% in the first quarter.",
  },
  {
    year: "2020",
    title: "Software Engineer at Digital Dynamics",
    description:
      "Developed and maintained core features for a SaaS product, focusing on improving performance and user experience.",
  },
  {
    year: "2018",
    title: "Junior Web Developer at Creative Co.",
    description:
      "Gained hands-on experience in front-end development, contributing to various client projects and mastering fundamental skills.",
  },
];
