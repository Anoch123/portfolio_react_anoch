...
const Hero = () => {
  ...
  return (
    <div className="bg-white" id="heroSection">
      <header className="absolute inset-x-0 top-0 z-50">
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          <div className="flex lg:flex-1">
            <a href="./" className="-m-1.5 p-1.5 animate-bounce">
              <span className="font-extrabold bg-clip-text text-transparent bg-gradient-to-br from-blue-600 to-purple-800">Anoch Dissanayake</span>
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              Full-Stack React Developer <span className='text-4xl'>&#128075;</span>
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Hi, I'm Anoch Dissanayake. A passionate Full-Stack React Developer based in Kaluthara, Sri Lanka 📍
            </p>
            <div className="py-8 lg:py-5 mx-auto max-w-screen-xl px-4">
              <div className="grid grid-cols-10 gap-3 text-gray-500 sm:gap-3 md:grid-cols-2 lg:grid-cols-12 dark:text-gray-400" style={{ display: 'flex', justifyContent: 'center' }}>
                <a href="https://github.com/Anoch123" className="flex justify-center items-center">
                ...
                <a href="https://lk.linkedin.com/in/anoch-dissanayake-71a9aa172" className="flex justify-center items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            ...
            <div className="py-8 lg:py-10 mx-auto max-w-screen-xl px-4">
              <p className="mb-2 lg:mb-5 text-1xl text-gray-500 tracking-tight text-center md:text-1xl">Tech Stack <span className='text-1xl'>&#128071;</span></p>
              <div className="grid grid-cols-3 gap-8 text-gray-500 sm:gap-8 md:grid-cols-3 lg:grid-cols-7 dark:text-gray-400">
